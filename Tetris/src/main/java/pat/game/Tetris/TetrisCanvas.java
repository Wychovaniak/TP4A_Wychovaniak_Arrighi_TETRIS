...
public class TetrisCanvas extends JPanel {
	...
	public void paintComponent(Graphics graphics) {
		...
		graphics.drawImage(
				blockInfo("Block en Stock", Color.YELLOW, game.getStoredBlock()),
				BLOCK_WIDTH * 12 -BORDER_WIDTH, BLOCK_WIDTH * 5, this);
		graphics.drawImage(
				blockInfo("Prochainement", Color.GREEN, game.getNextBlock()),
	...
	private BufferedImage printHighScore() {
		...
		g2d.setFont(new Font(Font.SANS_SERIF, Font.PLAIN, 18));
		FontMetrics fm = g2d.getFontMetrics(g2d.getFont());
		int w = fm.stringWidth("Record");
		g2d.drawString("Record", (bi.getWidth() - w) / 2,
				bi.getHeight() / 10);
